...
Study latest Google Antigravity technical approaches and best practices in https://antigravity.google/docs/get-started and ask to update the "AntiGravityPromt.md" file in the rood of this project folder with enhancements for future use.
...
1. **Initialize Project Memory**
    - Create:
	    ...
	    -  README.md → Has pointer references to what each folder contain and their intended purpose.  
...
- Deterministic React scripts. Atomic and testable.
...
Before building any Tool, you must define the **Data Schema** or update it in folder  database/ make sure this is referenced in `gemini.md`.
...
2. **Patch**: Fix any Python if used script in `tools/`.
...
├── docs/ # Layer 2: ("Documentation and reference materials") 
├── architecture/ # Layer 1: SOPs (The "How-To") 
├── tools/ # Layer 3: React Component documentation, etc (The "Engines") 
├── database/ # Layer 3: React Ts Scripts (The "dB Backend provider(s) choices SQL Lite, SupaBase, Google Firebase Engines") 
